...
import { isMedia, toModelFileData } from "@/util/media"
      ...
      for (const part of msg.parts) {
        ...
        if (part.type === "file" && part.mime !== "text/plain" && part.mime !== "application/x-directory") {
          if (options?.stripMedia && isMedia(part.mime)) {
            ...
            // AI SDK prefers data-URL MIME over mediaType; send raw base64 + concrete mediaType.
            const modelFile = toModelFileData({
              mime: part.mime,
              url: part.url,
