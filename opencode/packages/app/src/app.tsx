...
} from "@/pages/requirements/routes"
  ...
  return (
    <>
      ...
      >
        ...
        <Show when={!settings.general.newLayoutDesigns()}>
          <Route path="/requirements" component={RequirementsLayout}>
            <Route path="/" component={RequirementsListPage} />
            <Route path="/:id" component={RequirementsEditorPage} />
          </Route>
        </Show>
      </Route>
      <Show when={settings.general.newLayoutDesigns()}>
