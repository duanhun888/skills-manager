...
export default function FileTree(props: {
  ...
  onAddToChat?: (file: FileNode) => void
  ...
  const canAddToChat = () => !!props.onAddToChat

  const nodeContextMenu = (node: FileNode, children: ParentProps["children"]) => {
    if (!canAddToChat()) return children
    return (
      <ContextMenu>
        ...
        <ContextMenu.Portal>
          <ContextMenu.Content>
            <ContextMenu.Item onSelect={() => props.onAddToChat?.(node)}>
