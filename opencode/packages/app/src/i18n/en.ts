export const dict = {
  ...
  "requirements.create.noSystem": "No open projects yet. Open one from Home, or assign a system later in the editor.",
  ...
  "requirements.editor.noOpenProjects": "No open projects — open a system from Home first",
