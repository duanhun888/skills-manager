...
export const dict = {
  ...
  "prompt.toast.visionDescribe.title": "正在識圖…",
  "prompt.toast.visionDescribe.description": "先用組織設定的視覺模型識別截圖，再切回目前編碼模型繼續。",
  "prompt.toast.visionDescribeFailed.title": "識圖失敗",
  "prompt.toast.visionDescribeFailed.description": "無法識別圖片。請檢查 Skills 管理端「編碼區 OCR / 識圖模型」，或手動切換到視覺模型。",
  "prompt.toast.visionModelRequired.title": "未設定編碼區識圖",
  "prompt.toast.visionModelRequired.description": "目前模型不能看圖。請在 Skills「模型策略」設定 OCR 位址或 VL 模型（如 alibaba-cn/qwen3-vl-plus）並儲存，然後重新開啟 OpenCode；或手動切換到視覺模型。",
  "prompt.toast.ocrStart.title": "正在 OCR…",
  "prompt.toast.ocrStart.description": "先用本機 OCR 擷取截圖文字；異常時再走視覺模型。",
  "prompt.toast.ocrFallbackVision.title": "OCR 不可用，改用識圖模型",
  "prompt.toast.ocrFallbackVision.description": "本機 OCR 結果為空或異常，改用組織設定的視覺模型繼續。",
  "prompt.toast.visionFallbackOcr.title": "識圖失敗，改用 OCR",
  "prompt.toast.visionFallbackOcr.description": "視覺模型無有效結果，改用本機 OCR 繼續。",
