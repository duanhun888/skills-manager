...
export const dict = {
  ...
  "prompt.action.addToChat": "加入聊天",
  "prompt.action.removeFromChat": "从聊天移除",
  ...
  "prompt.toast.visionDescribeFailed.description": "无法识别图片。请检查 Skills 管理端「编码区 OCR / 识图模型」，或手动切换到视觉模型。",
  "prompt.toast.visionModelRequired.title": "未配置编码区识图",
  "prompt.toast.visionModelRequired.description": "当前模型不能看图。请在 Skills「模型策略」配置 OCR 地址或 VL 模型（如 alibaba-cn/qwen3-vl-plus）并保存，然后重新打开 OpenCode；或手动切换到视觉模型。",
  "prompt.toast.ocrStart.title": "正在 OCR…",
  "prompt.toast.ocrStart.description": "先用本地 OCR 提取截图文字；异常时再走视觉模型。",
  "prompt.toast.ocrFallbackVision.title": "OCR 不可用，改用识图模型",
  "prompt.toast.ocrFallbackVision.description": "本地 OCR 结果为空或异常，改用组织配置的视觉模型继续。",
  "prompt.toast.visionFallbackOcr.title": "识图失败，改用 OCR",
  "prompt.toast.visionFallbackOcr.description": "视觉模型无有效结果，改用本地 OCR 继续。",
  ...
  "home.title": "主页",
  "workbench.switch": "工作台切换",
  "workbench.home": "首页",
  "workbench.requirements": "需求工作台",
  "workbench.coding": "编码工作台",
  "home.projects": "项目",
  ...
  "settings.general.row.fileTreePosition.option.right": "右侧",
  "settings.general.row.chatPosition.title": "聊天位置",
  "settings.general.row.chatPosition.description": "将聊天放在审查/文件面板的左侧或右侧",
  "settings.general.row.chatPosition.option.left": "左侧",
  "settings.general.row.chatPosition.option.right": "右侧",
  ...
  "requirements.subtitle": "把截图、原型整理成便于 AI 编码的需求简报",
  "requirements.list.eyebrow": "需求工作台",
  "requirements.status.ready": "可交付",
  "requirements.status.progress": "整理中",
  "requirements.status.draft": "草稿",
  "requirements.meta.integration": "已配联调",
  "requirements.defaultTitle": "未命名需求",
  "requirements.empty": "还没有需求文档",
  "requirements.empty.hint": "新建时选择归属系统，从截图或原型开始整理需求",
  "requirements.notFound": "未找到该需求",
  "requirements.meta.assets": "{{count}} 个素材",
  "requirements.meta.spec": "Spec {{count}}/6",
  "requirements.list.search": "搜索需求标题或系统…",
  "requirements.list.count": "{{count}} 条需求",
  "requirements.list.systems": "{{count}} 个系统",
  "requirements.list.filter.all": "全部",
  "requirements.list.filter.unassigned": "未归属",
  "requirements.list.emptyFilter": "没有符合筛选的需求",
  "requirements.create.description": "创建需求简报，并指定要交付到哪个系统/项目",
  "requirements.create.systemRequired": "请选择归属系统",
  "requirements.create.noSystem": "还没有打开的项目。可点「浏览」选择任意本地目录，或稍后在编辑页指定。",
  "requirements.field.browseProject": "浏览",
  "requirements.panel.assets": "素材库",
  "requirements.panel.document": "需求文档",
  "requirements.panel.document.hint": "保持固定章节，方便编码助手直接消费",
  "requirements.panel.spec": "需求 Spec",
  "requirements.panel.spec.hint": "一整份可编辑文档；章节标题留给编码助手识别",
  "requirements.panel.assistant": "分析助手",
  "requirements.panel.assistant.hint": "素材加入输入框；发送后出现在气泡里并写入 Spec",
  "requirements.assets.empty": "拖入、粘贴或点击添加截图 / 原型图 / 文档",
  "requirements.assets.emptyTitle": "预览画布",
  "requirements.assets.dropHere": "松开鼠标以添加图片或文档",
  "requirements.assets.addImageOnly": "请选择图片文件（PNG / JPG / GIF / WebP）。",
  "requirements.assets.addUnsupported": "请选择图片或文档（PNG / JPG / PDF / Excel / CSV / Word / TXT 等）。",
  "requirements.assets.tooLargeTitle": "文件过大",
  "requirements.assets.tooLarge": "单个附件不能超过 8MB。",
  "requirements.assets.analyzeHint": "勾选要参与下一次分析的图片",
  "requirements.assets.includeInAnalysis": "参与分析",
  "requirements.assets.inChat": "已加入聊天",
  "requirements.field.title": "需求标题",
  "requirements.field.system": "关联项目",
  "requirements.field.systemPlaceholder": "选择编码项目",
  "requirements.field.linkedProject": "关联项目",
  "requirements.field.linkedProjectPlaceholder": "选择编码项目",
  "requirements.editor.needLinkedProject": "请先选择关联项目",
  "requirements.editor.noOpenProjects": "暂无项目，点「浏览」选择本地目录",
  "requirements.field.assetNote": "该素材备注",
  "requirements.field.assistantNotes": "观察到什么？目标、流程、文案、边界情况…",
  "requirements.action.new": "新建需求",
  "requirements.action.createConfirm": "创建并打开",
  "requirements.action.addAsset": "从本机选择图片或文档",
  "requirements.action.addAssetShort": "添加",
  "requirements.action.applyNotes": "合并笔记到目标",
  "requirements.action.sendToCoding": "送入编码",
  "requirements.action.backToList": "全部需求",
  "requirements.handoff.noProject": "请先打开一个项目，再把简报送入编码聊天。",
  "requirements.handoff.needContent": "请先分析素材或填写 Spec，再送入编码。",
  "requirements.handoff.footerHint": "右侧 Spec 只显示已勾选的对话；未勾选则为空",
  "requirements.handoff.chatHint": "勾选消息右侧方框后，内容才会写入右侧 Spec 并送入编码",
  "requirements.handoff.messagePick": "勾选后写入右侧 Spec，并随送入编码带上",
  "requirements.handoff.selectedCount": "已选 {{count}} 条",
  "requirements.handoff.selectAssistants": "全选助手回复",
  "requirements.handoff.clearSelection": "清除勾选",
  "requirements.handoff.dialogTitle": "选择送入编码的内容",
  "requirements.handoff.dialogHint": "只会带上右侧 Spec 与你勾选的附加信息，不会附带整段分析对话。",
  "requirements.handoff.sections": "Spec 章节",
  "requirements.handoff.sectionsHint": "已填写的章节默认勾选，可去掉无关项。",
  "requirements.handoff.noSections": "当前 Spec 还没有可送入的章节。",
  "requirements.handoff.extras": "附加信息",
  "requirements.handoff.includeIntegration": "连接器（Apifox / TAPD / 接口）",
  "requirements.handoff.includeAssets": "素材清单（文件名与备注）",
  "requirements.handoff.includeNotes": "分析助手备注",
  "requirements.handoff.includeNotesHint": "默认不勾选。备注常混入闲聊/失败提示，容易干扰编码。",
  "requirements.handoff.assets": "选择素材",
  "requirements.handoff.preview": "将送入的简报预览",
  "requirements.handoff.sending": "送入中…",
  "requirements.create.inheritIntegration": "将继承同系统的 Apifox / 环境配置；本需求接口需重新标注",
  "requirements.integration.title": "连接器 / Apifox",
  "requirements.integration.hint": "不含密钥",
  "requirements.integration.configured": "已填",
  "requirements.integration.configure": "配置联调",
  "requirements.integration.done": "完成",
  "requirements.integration.dialogHint": "绑定 Apifox、导入接口、复制/写入 MCP",
  "requirements.integration.emptySummary": "尚未配置联调环境与接口",
  "requirements.integration.apifoxBound": "已绑 Apifox",
  "requirements.integration.step1": "Apifox 项目",
  "requirements.integration.bindPlaceholder": "项目链接或项目 ID",
  "requirements.integration.resolvedId": "项目 ID {{id}}",
  "requirements.integration.folderId": "目录 ID",
  "requirements.integration.folderIdPlaceholder": "可选，例如 20406855",
  "requirements.integration.folderIdHint": "在 Apifox 左侧点目录 → 目录设置 → 基本信息里复制「目录ID」。留空则拉取整个项目。",
  "requirements.integration.apifoxGuide": "文档",
  "requirements.integration.token": "Access Token",
  "requirements.integration.tokenPlaceholder": "API 访问令牌",
  "requirements.integration.tokenHint": "仅保存在本机需求数据；不会写入编码 brief。复制/写入 MCP 时带入配置。",
  "requirements.integration.tokenDocs": "如何申请",
  "requirements.integration.readyHint": "已具备项目 ID 与 Token，可从 Apifox 导入接口或写入 MCP。",
  "requirements.integration.stepApis": "本需求接口",
  "requirements.integration.stepEnv": "联调环境",
  "requirements.integration.stepMcp": "MCP",
  "requirements.integration.mcpShow": "预览",
  "requirements.integration.mcpHide": "收起",
  "requirements.integration.env": "环境",
  ...
  "requirements.integration.openApifox": "打开",
  "requirements.integration.copyMcp": "复制配置",
  "requirements.integration.writeMcp": "写入项目",
  "requirements.integration.mcpWriting": "写入中…",
  "requirements.integration.mcpNeedId": "请先绑定 Apifox 项目",
  "requirements.integration.mcpNeedToken": "请先填写 Access Token",
  "requirements.integration.mcpNeedProject": "请先关联编码项目",
  "requirements.integration.mcpNeedProjectHint": "关联编码项目后，可一键把 Apifox MCP 写入该项目 config.json 并启用。",
  "requirements.integration.mcpCopied": "已复制 MCP 配置",
  "requirements.integration.mcpCopiedHint": "粘贴到关联项目的 .opencode/opencode.json（OpenCode 用 mcp，不是 mcpServers）",
  "requirements.integration.mcpCopiedWithToken": "已包含表单 Token；可粘贴到项目配置或点「写入项目」",
  "requirements.integration.mcpCopyFailed": "复制失败，请手动复制",
  "requirements.integration.mcpWritten": "已写入关联项目 MCP",
  "requirements.integration.mcpWrittenHint": "已合并到项目 config.json，并启用「{{name}}」",
  "requirements.integration.mcpWrittenRuntimeHint": "已写入 config.json；若当前会话未立刻连上，可重开项目后再试",
  "requirements.integration.mcpWriteFailed": "写入 MCP 失败",
  "requirements.integration.importFromApifox": "从 Apifox 导入",
  "requirements.integration.importing": "拉取中…",
  "requirements.integration.importNeed": "请先填写项目 ID 与 Access Token",
  "requirements.integration.importNeedPick": "请先勾选要导入的接口",
  "requirements.integration.importFailed": "从 Apifox 拉取接口失败",
  "requirements.integration.importEmpty": "未拉到可用接口（多模块项目已尝试全部模块；请核对 Project ID / Token）",
  "requirements.integration.importEmptyFolder": "该目录下未拉到接口，请核对目录 ID",
  "requirements.integration.importLoaded": "已拉取 {{count}} 个接口，请勾选后导入",
  "requirements.integration.importLoadedSchema": "其中 {{count}} 个带有请求/响应 Schema 摘要",
  "requirements.integration.importLoadedNoSchema": "本次未解析到 Schema，可检查 Apifox 导出或稍后重试",
  "requirements.integration.importSearch": "搜索 method / path / 名称",
  "requirements.integration.importSelectAll": "全选",
  "requirements.integration.importClear": "清除",
  "requirements.integration.importApply": "导入已选 {{count}}",
  "requirements.integration.apiCount": "{{count}}",
  "requirements.integration.apiPathPlaceholder": "/path",
  "requirements.integration.apiNamePlaceholder": "接口名称",
  "requirements.integration.addApi": "添加",
  "requirements.integration.addApiNeedPath": "请先填写路径或名称",
  "requirements.integration.bulkPaste": "批量粘贴",
  "requirements.integration.bulkCancel": "取消",
  "requirements.integration.clearApis": "清空全部",
  "requirements.integration.selectAllApis": "全选",
  "requirements.integration.clearApiSelection": "取消勾选",
  "requirements.integration.deleteSelectedApis": "删除所选 ({{count}})",
  "requirements.integration.deleteNeedPick": "请先勾选要删除的接口",
  "requirements.integration.deletedCount": "已删除 {{count}} 个接口",
  "requirements.integration.bulkPlaceholder": "每行：POST /path 名称",
  "requirements.integration.bulkImport": "导入",
  "requirements.integration.bulkImported": "已导入 {{count}} 个接口",
  "requirements.integration.bulkUpdated": "已更新 {{count}} 个接口的 Schema",
  "requirements.integration.bulkImportedAndUpdated": "新增 {{added}} 个，更新 Schema {{updated}} 个",
  "requirements.integration.notes": "备注",
  "requirements.integration.notesPlaceholder": "鉴权、代理、Header（勿填 Token）",
  "requirements.connector.title": "连接器",
  "requirements.connector.menu": "添加与连接",
  "requirements.connector.apifox": "Apifox",
  "requirements.connector.apifoxDesc": "读取接口文档，按路径生成调用代码与 DTO",
  "requirements.connector.tapd": "TAPD",
  "requirements.connector.tapdDesc": "管理需求、缺陷、任务和迭代，查询进度与状态流转",
  "requirements.connector.tapdBound": "已绑 TAPD",
  "requirements.connector.connected": "已连接",
  "requirements.connector.manage": "管理",
  "requirements.connector.add": "添加",
  "requirements.connector.search": "搜索连接器…",
  "requirements.connector.catalogHint": "选择要关联的外部环境",
  "requirements.connector.noMatch": "没有匹配的连接器",
  "requirements.connector.hint": "连接 Apifox / TAPD，分析时可对照外部文档",
  "requirements.connector.emptySummary": "尚未连接外部环境",
  "requirements.tapd.title": "TAPD",
  "requirements.tapd.dialogHint": "绑定项目空间与 Token，复制 MCP 配置",
  "requirements.tapd.workspace": "项目 / 空间",
  "requirements.tapd.bindPlaceholder": "TAPD 链接或 workspace ID",
  "requirements.tapd.resolvedId": "Workspace ID {{id}}",
  "requirements.tapd.story": "本需求单（可选）",
  "requirements.tapd.storyPlaceholder": "需求 / 缺陷 / 任务完整链接，或短 ID（如 1031026）",
  "requirements.tapd.token": "Access Token",
  "requirements.tapd.tokenPlaceholder": "个人访问令牌",
  "requirements.tapd.tokenHint": "仅保存在本机需求数据；不会写入编码 brief。复制 MCP 时写入配置。",
  "requirements.tapd.tokenDocs": "如何申请",
  "requirements.tapd.guide.open": "在哪儿找？",
  "requirements.tapd.guide.workspaceTitle": "项目 / 空间 ID 在哪儿",
  "requirements.tapd.guide.workspaceHint": "在 TAPD 里按图示位置复制 Workspace / 项目 ID",
  "requirements.tapd.guide.storyTitle": "需求单 ID 在哪儿",
  "requirements.tapd.guide.storyHint": "打开对应需求 / 缺陷 / 任务，按图示复制链接或短 ID",
  "requirements.tapd.guide.tokenTitle": "Access Token 在哪儿",
  "requirements.tapd.guide.tokenHint": "在 TAPD 开放平台 / 个人设置里按图示创建并复制 Token",
  "requirements.tapd.guide.pending": "示意图尚未放好。请把截图保存为下方路径后的文件名，刷新即可显示。",
  "requirements.tapd.mcp": "MCP",
  "requirements.tapd.copyMcp": "复制配置",
  "requirements.tapd.docs": "开放平台",
  "requirements.tapd.open": "打开",
  "requirements.tapd.mcpNeedId": "请先绑定 TAPD 项目空间",
  "requirements.tapd.mcpCopied": "已复制 TAPD MCP 配置",
  "requirements.tapd.mcpCopiedHint": "粘贴到关联项目的 .opencode/opencode.json（OpenCode 用 mcp，不是 mcpServers）",
  "requirements.tapd.mcpCopiedWithToken": "已包含表单 Token；粘贴到 .opencode/opencode.json 即可",
  "requirements.tapd.mcpCopyFailed": "复制失败，请手动复制",
  "requirements.tapd.import": "导入",
  "requirements.tapd.importSection": "从需求单导入",
  "requirements.tapd.importAction": "导入到素材库",
  "requirements.tapd.importFromTapd": "从 TAPD 导入（图片和文档）",
  "requirements.tapd.importFromTapdHint": "从已绑定的 TAPD 需求单拉取贴图与附件文档到素材库",
  "requirements.tapd.importing": "导入中…",
  "requirements.tapd.importNeed": "请先填写 Workspace、本需求单链接和 Access Token",
  "requirements.tapd.importOk": "已导入 {{count}} 个文件到素材库（含图片与附件文档）",
  "requirements.tapd.importPartial": "导入 {{ok}} 个，失败 {{fail}} 个",
  "requirements.tapd.importEmpty": "该需求单未找到可导入的图片或附件",
  "requirements.tapd.importFailed": "从 TAPD 导入失败",
  "requirements.tapd.importHint": "把需求描述里的贴图，以及附件区的 Excel / PDF / Word 等拉进左侧素材库（单文件 ≤8MB）",
  "requirements.tapd.fileDoc": "文档",
  "requirements.assets.previewDoc": "文档已保存到素材库，内容无法在此预览",
  "requirements.assets.previewPdf": "PDF 可在下方打开；分析请用截图类图片",
  "requirements.assets.previewLoading": "正在生成预览…",
  "requirements.assets.previewUnavailable": "暂无法解析该文件内容，可下载后查看",
  "requirements.assets.openFile": "下载 / 打开",
  "requirements.assets.analyzeImagesOnly": "仅图片可勾选参与分析",
  "requirements.tapd.permissionsIntro": "连接后，编码助手可通过 MCP 访问：",
  "requirements.tapd.perm.story": "读写需求",
  "requirements.tapd.perm.task": "读写任务",
  "requirements.tapd.perm.bug": "读写缺陷",
  "requirements.tapd.perm.iteration": "查询迭代与进度",
  "requirements.chat.empty": "上传截图后加入聊天，提问并发送。助手会看图并填充右侧 Spec。",
  "requirements.chat.emptyTitle": "从截图开始拆需求",
  "requirements.chat.placeholder": "例如：这是登录页原型，请拆出页面结构、交互和文案…",
  "requirements.chat.send": "发送",
  "requirements.chat.sending": "分析中…",
  "requirements.chat.thinking": "正在分析素材…",
  "requirements.chat.thinkingReply": "正在回复…",
  "requirements.chat.clear": "清空对话",
  "requirements.chat.noModel": "没有可用模型，请先在设置里连接模型提供商。",
  "requirements.chat.needVisionModelTitle": "当前模型不支持看图",
  "requirements.chat.needVisionModel": "请换成支持图片的模型（例如 Qwen-VL / qwen3-vl），再发送截图分析。",
  "requirements.chat.model": "模型：{{model}}",
  "requirements.chat.assetCount": "本轮附带 {{count}} 个素材",
  "requirements.chat.attached": "（附件：{{names}}）",
  "requirements.chat.emptyReply": "模型没有返回可用内容，请再试一次。",
  "requirements.chat.failedTitle": "需求分析失败",
  "requirements.chat.failed": "分析失败：{{message}}",
  "requirements.chat.step1": "左侧添加截图或原型",
  "requirements.chat.step2": "把素材加入输入框，提问后点「发送」",
  "requirements.chat.step3": "检查并编辑右侧 Spec，再「送入编码」",
  "requirements.spec.goal": "目标",
  "requirements.spec.pages": "页面 / 屏幕",
  "requirements.spec.interactions": "交互",
  "requirements.spec.copy": "文案",
  "requirements.spec.constraints": "约束",
  "requirements.spec.acceptance": "验收",
  "requirements.spec.placeholder": "勾选中间对话后，结构化内容会出现在这里…",
  "requirements.spec.emptyUntilChecked": "尚未勾选对话。请在中间分析助手勾选消息，内容才会写入这里。",
  "requirements.spec.filled": "{{count}}/6 已填",
  "requirements.titlebar.current": "点击返回首页",
  "requirements.titlebar.backHome": "回首页",
