...
export function createReviewPanelV2State() {
  const [store, setStore, , ready] = persisted(
    ...
    createStore({
      // Default closed: the session file tree is the primary explorer (Cursor-style).
      // Users can still open this sidebar manually when needed.
      sidebarOpened: false,
  ...
  return {
    ...
    setSidebarOpened: (opened: boolean) => setStore("sidebarOpened", opened),
