...
fn build_tray_menu_from_data<R: tauri::Runtime>(
    ...
    let app_name = MenuItem::with_id(app, "tray-app-name", "芯宏Skills仓库", false, None::<&str>)?;
    ...
    let show_item = MenuItem::with_id(app, "show", "打开芯宏Skills仓库", true, None::<&str>)?;
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::opencode_bundle::sync_opencode_user_image_policy,
            ...
            commands::skills::set_server_skill_id,
            commands::skills::get_linked_server_project_id,
            ...
            // Central server auth (Rust HTTP proxy — avoids WebView CSP/CORS)
            commands::server_auth::server_login,
            commands::server_auth::server_fetch_me,
            commands::server_auth::server_health,
            commands::server_auth::server_fetch_public_config,
            commands::server_auth::server_api_request,
            commands::server_auth::server_upload_bytes,
            commands::server_auth::server_download_bytes,
            commands::skill_storage::upload_skill_content_to_server,
            commands::skill_storage::download_skill_content_from_server,
            commands::server_install::install_from_server,
            commands::server_install::check_server_skill_update,
            commands::server_install::update_skill_from_server,
            // Git Backup
            ...
            commands::projects::project_agent_has_skill_dir,
            ...
            commands::projects::set_project_server_link,
