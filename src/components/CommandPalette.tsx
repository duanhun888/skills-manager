...
import { COMMAND_PALETTE_Z_INDEX } from "../lib/layoutChrome";
...
export function CommandPalette() {
  ...
  const items = useMemo<PaletteItem[]>(() => {
    ...
    const skillItems: PaletteItem[] = managedSkills
      ...
      .map((s) => ({
        ...
        run: () => {
          navigate("/my-skills", { state: { openSkillId: s.id } });
        },
      }));
  ...
  return (
    <div
      className="fixed inset-0 flex items-start justify-center bg-black/30 pt-[14vh] backdrop-blur-[2px]"
